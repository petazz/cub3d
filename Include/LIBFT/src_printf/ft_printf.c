...
/*   Updated: 2024/06/27 14:57:44 by misaguir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_format(char type, va_list element)
{
	...
	if (type == 'c')
		...
		count += ft_putstr_pf_pf(va_arg(element, char *));
	else if (type == 'p')
		count += ft_p((unsigned long)va_arg(element, void *));
	else if (type == 'd')
		count += ft_putnbr_pf_pf(va_arg(element, int));
	else if (type == 'i')
		count += ft_putnbr_pf_pf(va_arg(element, int));
	else if (type == 'u')
		count += ft_putnbr_pf_unsigned(va_arg(element, unsigned int));
	else if (type == 'x')
