...
void	draw_player(void *data)
{
	...
	scale_x = (double)MINIMAP_WIDTH / game->max;          // Escalado horizontal
	scale_y = (double)MINIMAP_HEIGHT / game->count_map;  // Escalado vertical

    player_x = (int)(game->x * scale_x); // Convertir coordenadas del mapa a coordenadas del minimapa
